...
<body>
    ...
    <div class="contactus_container">
        ...
        <center>    
        <div class="map">
            <div class="location"><b>▷ Our Location:</b></div>
            <iframe class="map_box" src="https://www.google.com/maps/embed/v1/place?q='Auckland','450 queen street'&key=AIzaSyBVgJGJcNCnpQS3-XJdH5hQPfZV2VqXe0c "></iframe>  
        ...
        <br>
            ...
            <br>
            <div><b>▷ Call Us </b></div>
            <div>+64 021 123 456</div>
            </div>
        </center>
    
            <div class="enquiry_title"><b>Enquiry Form</b></div>
             <div class="enquiry_form">
                <div class="form_content">Name:</div>
                <input type="text" name="name" required="required" placeholder="Name">
                <div class="form_content">E-mail:</div>
                <input type="email" name="email" required="required" placeholder="Email">
                <div class="form_content">Your Message:</div>
