...
<body>
	...
	<div class="product_title">
		<h1>Wine Glass Set</h1>
	</div>
	<div class="products_container">
		<div class="wrap">
			<div class="product_imag"><img class src="images/image1.jpg"></div>
			<div class="price">$200</div>
			<input type="button" name="add" value="Add to Cart" class="button2" onclick="location.href='#'"/>
		</div>
		<div class="wrap">
			<div class="product_imag"><img src="images/image2.jpg" width="300px"></div>
			<div class="price">$200</div>
			<input type="button" name="add" value="Add to Cart" class="button2" onclick="location.href='#'"/>
		</div>
		<div class="wrap">
			<div class="product_imag"><img src="images/image4.jpg" width="300px"></div>
	...
	<div class="product_title">
			...
			<div class="wrap_2">
			<input type="button" value="Go to Customer Reivews" class="reviewbutton" onclick="location.href='review.php'"/>
		</div>
